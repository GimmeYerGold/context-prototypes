...
var Student = function(expertise) {
    this.expertise = expertise
    this.knowledge = 0;
    this.learn = function(knowPower) {
        this.knowledge += knowPower
    }
}
...
var Safe = function(sensitive, masterKey) {
    this.unlock = function(servantKey) {
        if (masterKey === servantKey) {
            return sensitive
        }
    }
}
